...
CREATE TABLE OLLE_USER(
	...
	USER_SECDATE DATE  DEFAULT SYSDATE NOT NOT NULL, 
	USER_IMG VARCHAR2(1000) NOT NOT NULL, 
	USER_NICK VARCHAR2(500) NOT NOT NULL
);

ALTER TABLE OLLE_USER ADD CONSTRAINT USER_MEMBER_CHK CHECK USER_MEMBER IN ('개인', '사업자');
ALTER TABLE OLLE_USER ADD CONSTRAINT USER_WARNING_CHK CHECKUSER_WARNING < 6);
...
COMMENT ON COLUMN OLLE_USER.USER_STATUS IS '탈퇴여부(N)';
...
ALTER TABLE OLLE_HASHTAG ADD CONSTRAINT BOARD_NUM_CHK CHECK BOARD_NUM IN (1, 2, 3, 4);
--1 : 관광일정, 2 : 추천일정, 3 : 나만의 일정, 4 : 제주상황
...
ALTER TABLE OLLE_DIB ADD CONSTRAINT BOARD_NUM_CHK CHECK BOARD_NUM IN (1, 2, 3, 4);
--1 : 관광일정, 2 : 추천일정, 3 : 나만의 일정, 4 : 제주상황
...
CREATE TABLE OLLE_BOOKING(
	...
	SITU_NUM NUMBERNOT NULL, 
	BOOK_NAME VARCHAR2(500) NOT NULL, 
	BOOK_PEOPLE NUMBERNOT NULL, 
