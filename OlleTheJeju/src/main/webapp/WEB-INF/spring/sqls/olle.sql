...
values(1, '나홀로 제주에', '혼자 제주도를 가는 느낌이란 참 특별합니다.', 'user1', SYSDATE, 'test.jpg', '혼자', '제주시 소월읍 미장1동', '1박2일', 13, 15, 0);
insert into OLLE_PLAN
values(2, '나홀로 제주에', '혼자 제주도를 가는 느낌이란 참 특별합니다.', 'user1', SYSDATE, 'test.jpg', '혼자', '제주시 소월읍 미장1동', '1박2일', 13, 15, 1);
