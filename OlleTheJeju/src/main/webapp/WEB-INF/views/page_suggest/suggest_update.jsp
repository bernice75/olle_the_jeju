                        ...
                        <div class="place-info">
                            <fieldset>
                                <section>
                                    ...
                                    <input type="text" class="form-control" name="sug_title" maxlength='21' value="${dto.getSug_title }">
                                </section>
                                <section>
                                    <label for="sug_content">내용 : </label>
                                    <textarea rows="10" cols="40" class="form-control" name="sug_content" value="${dto.getSug_content }"></textarea>
                                </section>
                                <section>
