...
<html>
	<head>
        ...
        <link href="./resources/css/trip/trip_insert.css" rel="stylesheet" type="text/css" />
                    ...
                    <div class="main-place">
                        ...
                        <div class="place-info">
                            <fieldset>
                                ...
                                <section>
                                    <label for="trip_term" style="margin-right: 180px;">영업시작 : <input type="time" id="trip_term" class="form-control start_time" name="start_time"></label>
                                    <label for="trip_term">영업마감 : <input type="time" class="form-control end_time" name="end_time"></label>
                                </section>
                                <section>
                                ...
                                <section>
                                    <label for="trip_addr">전화번호 : </label>
