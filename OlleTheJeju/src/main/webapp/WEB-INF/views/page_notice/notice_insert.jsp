	            ...
	            <form class="not_write_form">
	                ...
	                <table>
	                    ...
	                    <tr>
	                        <th>내용</th>
	                        <td>
	                            <textarea rows="10" cols="60" class="form_textarea form-control" placeholder="내용을 입력해주세요"></textarea>
	                        </td>
	                    </tr>
	                </table>
	                ...
	                &nbsp;&nbsp;&nbsp;
	                <button onclick="location.href='notice_main.do'" class="btn btn-secondary">취소</button>
	                </div>
	            </form>
